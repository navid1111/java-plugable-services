...
@Table(name = "media_upload_intents", uniqueConstraints =
        @UniqueConstraint(name = "uk_media_intent_owner_key", columnNames = {"owner_username", "idempotency_key"}))
public class MediaUploadIntent {
    ...
    public MediaUploadIntent(UUID id, String owner, String type, String targetId, String key,
            String resourceType, String format, long maxBytes, String publicId, Instant expiresAt) {
        this.id=id; ownerUsername=owner; targetType=type; this.targetId=targetId; idempotencyKey=key;
